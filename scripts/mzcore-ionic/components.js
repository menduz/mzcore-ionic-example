...
define(["require", "exports"], function (require, exports) {
    ...
    var IonInputBase = (function (_super) {
        ...
        ], IonInputBase.prototype, "disabled");
    ...
    var IonItemToggle = (function (_super) {
        ...
        ], IonItemToggle.prototype, "label");
        __decorate([
            mz.MVCObject.proxy, 
            __metadata('design:type', String)
        ], IonItemToggle.prototype, "mood");
    ...
    var IonPopup = (function (_super) {
        ...
        __decorate([
            IonPopup.proxy, 
            __metadata('design:type', String)
        ], IonPopup.prototype, "title");
        __decorate([
            IonPopup.proxy, 
            __metadata('design:type', String)
        ], IonPopup.prototype, "sub_title");
        __decorate([
            IonPopup.proxy, 
            __metadata('design:type', Boolean)
        ], IonPopup.prototype, "loading");
        __decorate([
            IonPopup.proxy, 
            __metadata('design:type', String)
        ], IonPopup.prototype, "width");
        __decorate([
            IonPopup.Attribute, 
            __metadata('design:type', Boolean)
        ], IonPopup.prototype, "visible");
        IonPopup = __decorate([
